...
<html>
  ...
  <body>
    <form action="<?php echo e(route('has')); ?>" method="post" class="decor" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\user\Desktop\mora\resources\views/alihasba.blade.php ENDPATH**/ ?>